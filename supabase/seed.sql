...
-- ─── Auth user ────────────────────────────────────────────────────────────────
-- Every RLS policy on this schema requires auth.role() = 'authenticated',
-- so there must be a real user to log in as.
...
insert into auth.identities (
  ...
  'aaaaaaaa-0000-4000-8000-000000000001',
  'aaaaaaaa-0000-4000-8000-000000000001',
  '{"sub":"aaaaaaaa-0000-4000-8000-000000000001","email":"qm@troop.test","email_verified":true,"phone_verified":false}'::jsonb,
  'email', now(), now(), now()
);
...
insert into members (id, auth_user_id, full_name, email, role, active) values
  ...
  -- inactive, to exercise the Members tab "show inactive" toggle
  ('b0000000-0000-4000-8000-000000000007', null,
   'Old Scout',   'former@troop.test',    'scout',            false);
